...
// arModel is a active record design model for table links operations.
type arModel struct {
	gmvc.M
}

var (
	// Table is the table name of links.
	Table = "links"
	// Model is the model object of links.
	Model = &arModel{g.DB("default").Table(Table).Safe()}
	// Columns defines and stores column names for table links.
	Columns = struct {
		Id    string //   
        Name  string //   
        Url   string //
